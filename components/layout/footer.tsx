...
export function Footer() {
  return (
    <footer className="bg-slate-900 text-slate-200">
      ...
      {/* Main Footer Content */}
      <div className="container mx-auto px-4 py-12">
        {/* Tambahkan max-w-7xl mx-auto di sini */}
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                Portal berita resmi Pemerintah Kabupaten Merauke, menyajikan
                informasi terkini seputar pemerintahan, pembangunan, dan
                kegiatan di wilayah Merauke.
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-slate-400" suppressHydrationWarning>
              © {new Date().getFullYear()} Pemerintah Kabupaten Merauke. All
              rights reserved.
            </p>
